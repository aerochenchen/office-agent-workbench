...
pub trait SessionExt: 'static {
    ...
    //fn connect_async<P: FnOnce(Result<gio::IOStream, glib::Error>) + 'static, Q: FnOnce(Result<gio::IOStream, glib::Error>) + 'static>(&self, uri: &mut URI, cancellable: Option<&impl IsA<gio::Cancellable>>, progress_callback: P, callback: Q);

    //
    //#[cfg(any(feature = "v2_62", feature = "dox"))]
    //#[cfg_attr(feature = "dox", doc(cfg(feature = "v2_62")))]
    //fn connect_async_future<P: FnOnce(Result<gio::IOStream, glib::Error>) + 'static>(&self, uri: &mut URI, progress_callback: P) -> Pin<Box_<dyn std::future::Future<Output = Result<gio::IOStream, glib::Error>> + 'static>>;
