...
- [ ] 技能列表含 `government-document-format`、`meeting-followup`、`material-gap`、`sheet-to-brief`、`one-to-three`、`brief-deck`、`chart-generation`、`doc-proofread` 等预置技能（bundled seed）
- [ ] `~/.office-agent/` 已创建
