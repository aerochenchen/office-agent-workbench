...
- 交付：`output/会议纪要.md`、`output/待办台账.md`（含责任人/时限/事项）、`output/催办说明.md`（按需）
- 待办项不得缺少「事项」；缺责任人或时限须在台账标注「待明确」

### material-gap
- 触发：文件夹摸底、缺啥补啥
- 交付：`output/材料清单.md`；缺料模式另交 `output/缺料检查表.md`
...
- 交付：`output/情况说明.md` 或 `output/数据结论.md` 或填好的表 + `output/填报缺口.md`
